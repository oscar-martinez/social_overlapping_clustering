    ...
    for t in range(T):
        ...
        for listener in listenersOrder:
            ...
            for j, speaker in enumerate(speakers):
                ...
                labels[list(memory[speaker].keys())[np.random.multinomial(1,[freq/total for freq in memory[speaker].values()]).argmax()]] += G[listener][speaker]['weight']
